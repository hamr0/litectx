...
- **Embeddings OFF by default.** The only opt-in tier. Dual-hybrid (BM25 + ACT-R) ≈ 85% vs tri-hybrid ≈ 95%; embeddings add 15–19s cold latency + an ML dep. Not worth defaulting on.
